...
import me.whiteship.inflearnthejavatest.FindSlowTestExtension;
...
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) // 특정 순서대로 테스트를 실행하고 싶을 때s는 @TestInstance(Lifecycle.PER_CLASS)와 @TestMethodOrder를 사용한다.
